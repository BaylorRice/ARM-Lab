...
REM
REM Generated by Vivado on Mon Apr 15 13:40:45 -0500 2024
...
echo "xvlog --incr --relax -L uvm -prj datapath_vlog.prj"
call xvlog  --incr --relax -L uvm -prj datapath_vlog.prj -log xvlog.log
