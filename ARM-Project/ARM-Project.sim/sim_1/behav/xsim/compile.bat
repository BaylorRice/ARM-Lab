...
REM
REM Generated by Vivado on Mon Mar 11 13:26:47 -0500 2024
...
echo "xvlog --incr --relax -L uvm -prj fd_integration_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fd_integration_vlog.prj -log xvlog.log
