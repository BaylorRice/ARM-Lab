...
REM
REM Generated by Vivado on Tue Apr 23 15:39:06 -0500 2024
...
echo "xvlog --incr --relax -L uvm -prj division_vlog.prj"
call xvlog  --incr --relax -L uvm -prj division_vlog.prj -log xvlog.log
