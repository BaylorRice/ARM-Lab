...
REM
REM Generated by Vivado on Mon Jan 22 13:33:22 -0600 2024
...
echo "xvlog --incr --relax -L uvm -prj register_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj register_test_vlog.prj -log xvlog.log
