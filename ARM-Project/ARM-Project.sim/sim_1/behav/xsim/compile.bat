...
REM
REM Generated by Vivado on Mon Mar 25 12:53:19 -0500 2024
...
echo "xvlog --incr --relax -L uvm -prj alu_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj alu_test_vlog.prj -log xvlog.log
