...
REM
REM Generated by Vivado on Thu Feb 01 16:47:37 -0600 2024
...
echo "xvlog --incr --relax -L uvm -prj iFetch_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj iFetch_test_vlog.prj -log xvlog.log
