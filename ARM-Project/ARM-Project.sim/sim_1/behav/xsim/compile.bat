...
REM
REM Generated by Vivado on Mon Jan 29 12:16:58 -0600 2024
...
echo "xvlog --incr --relax -L uvm -prj adder_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj adder_test_vlog.prj -log xvlog.log
