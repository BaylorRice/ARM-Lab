...
REM
REM Generated by Vivado on Mon Feb 19 13:40:47 -0600 2024
...
echo "xvlog --incr --relax -L uvm -prj control_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj control_test_vlog.prj -log xvlog.log
