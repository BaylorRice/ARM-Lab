...
REM
REM Generated by Vivado on Thu Mar 28 13:42:20 -0500 2024
...
echo "xvlog --incr --relax -L uvm -prj iExecute_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj iExecute_test_vlog.prj -log xvlog.log
