...
REM
REM Generated by Vivado on Wed Feb 28 13:06:52 -0600 2024
...
echo "xvlog --incr --relax -L uvm -prj iDecode_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj iDecode_test_vlog.prj -log xvlog.log
