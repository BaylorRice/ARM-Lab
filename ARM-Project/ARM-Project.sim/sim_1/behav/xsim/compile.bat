...
REM
REM Generated by Vivado on Wed Apr 03 15:00:03 -0500 2024
...
echo "xvlog --incr --relax -L uvm -prj iMemory_test_vlog.prj"
call xvlog  --incr --relax -L uvm -prj iMemory_test_vlog.prj -log xvlog.log
